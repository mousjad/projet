...
def main(_):
    ...
    solver = Solver(model, batch_size=100, pretrain_iter=2000, train_iter=2000, sample_iter=100,
                    face_dir='face_data', anime_dir='anime_data', model_save_path=FLAGS.model_save_path, sample_save_path=FLAGS.sample_save_path)
